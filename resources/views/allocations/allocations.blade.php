...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add Truck</button>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    @foreach ($allocations as $trucks)
                      <tr>
                        <td>{{$allocations->reg_number}}</td>
                        <td>{{$allocations->company->company_name}}</td>
                        <td>{{$allocations->cluster->cluster_name}}</td>
                        <td>{{$allocations->truck_type->truck_type_name}}</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
